...
//    env.put(Context.SECURITY_PRINCIPAL, CXConfiguration.getParameterAsString("LDAP_AUTH_DN"));
//    env.put(Context.SECURITY_CREDENTIALS, CXConfiguration.getParameterAsString("LDAP_AUTH_PASSWORD"));
  ...
  //  LdapContext ctx = new InitialLdapContext();
    ...
    TestLdapConnection ldap = new TestLdapConnection();
